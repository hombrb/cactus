...
keywords: jouer au cactus en ligne, cactus jeu en ligne gratuit, jeu de cartes en ligne sans inscription, dutch en ligne
related: regles-du-jeu-de-cactus, cactus-dutch-tamalou-cabo-pablo, comment-gagner-au-cactus
---

## Un seul téléphone, posé à plat

C'est le mode pour lequel l'application a été construite. Le téléphone se pose à
plat sur la table, en mode portrait, entre les deux joueurs : **chacun voit sa
moitié à l'endroit**, la pioche et la défausse sont au milieu.
...
## Un téléphone chacun, à distance
...
Toutes les variantes décrites dans
[notre comparatif Cactus / Dutch / Tamalou / Cabo](/blog/cactus-dutch-tamalou-cabo-pablo/)
sont des réglages :

- quelles cartes ont un pouvoir, **carte par carte** ;
- la défausse rapide, activée ou non ;
- les pouvoirs qui se déclenchent aussi sur une carte de votre propre jeu qui part à
  la défausse ;
- la carte retournée au départ, la prise dans la défausse ;
...
Le jeu sur un seul téléphone n'a **besoin d'aucune connexion**. Une fois la page
ouverte une première fois, elle reste disponible : dans le métro, en avion, en
...
À deux, dans les deux modes. Le jeu à plus de deux joueurs sur des téléphones
séparés est la suite prévue : le moteur du jeu est déjà écrit pour, et les salons
sont conçus pour l'accueillir.

## Questions fréquentes

### Faut-il créer un compte pour jouer au Cactus en ligne ?

Non. Le jeu sur un seul téléphone ne demande rien du tout, et une partie à distance
demande seulement un pseudo, affiché aux autres joueurs du salon.

### Est-ce que le jeu est vraiment gratuit ?

Oui, entièrement : pas d'achat, pas d'abonnement, pas de publicité, pas d'achat
intégré. Le code source est public.

### Comment jouer au Cactus à distance avec un ami ?

L'un crée une partie et reçoit un code de six caractères, l'autre entre ce code pour
rejoindre le salon. Quand les deux joueurs sont là, l'hôte lance la partie.

### Peut-on jouer sans connexion internet ?

Oui, pour le mode à deux sur un seul téléphone : le jeu fonctionne hors ligne une
fois la page ouverte une première fois. Le mode à distance, lui, a besoin d'une
connexion.
...
### Peut-on choisir ses règles ?

Oui. Les pouvoirs se règlent carte par carte, la défausse rapide s'active ou se
désactive, et le seuil de fin de partie se choisit. En ligne, les réglages de l'hôte
s'appliquent à toute la table et sont affichés dans le salon.
