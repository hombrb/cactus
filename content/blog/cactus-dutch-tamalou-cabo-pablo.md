...
related: regles-du-jeu-de-cactus, comment-gagner-au-cactus, jeux-de-cartes-a-deux
---

## Un jeu, dix noms

Cactus, **Dutch**, **Tamalou**, **Cabo**, **Kabo**, **Pablo**, **Gabo**,
**Marmotte** : tous désignent le même jeu de cartes à information cachée, dans
lequel on cherche le total le plus bas et où l'on annonce la fin de la manche en
prononçant un mot.

Il n'existe **aucune règle officielle**. Le jeu s'est transmis dans les cours de
récréation, les colonies de vacances et les soirées étudiantes, et chaque
transmission a laissé sa marque. Deux tables qui se disent d'accord sur « les
règles du Cactus » jouent souvent deux jeux légèrement différents.

Cela n'a rien d'anecdotique : la valeur du roi noir, à elle seule, change
complètement la façon de jouer une manche.
...
littérature anglophone : mêmes principes, quatre cartes cachées, on frappe pour
finir.

## Ce qui change vraiment d'une table à l'autre

| Règle | Version la plus jouée | Autres versions |
|---|---|---|
| Valeur du roi rouge | 0 | −1, −2 |
| Valeur du roi noir | 13 | 15, 20, ou 0 comme les autres |
| Figures | Dame 12, Valet 11 | toutes à 10 |
| Cartes regardées au départ | 2 | 1 (plus dur), 3 (plus facile) |
| Cartes à pouvoir | 7/8, 9/10, V/D, roi noir | le 8 seul ; version Cambio décalée |
| Pouvoir de l'As | désactivé | donner la carte piochée à un adversaire |
| Défausse rapide | autorisée | interdite, ou avec 2 cartes de pénalité |
| Défausse rapide sur la carte d'un adversaire | non | oui, en lui donnant une des siennes |
| Carte retournée à la distribution | oui | non, la défausse commence vide |
| Prendre la carte de la défausse | autorisé | pioche seulement |
| Seuil pour annoncer | aucun | il faut se croire sous 5 ou sous 6 |
| Égalité avec l'annonceur | l'annonce échoue | l'annonce réussit |
...
### La version « Dutch » complète

Roi rouge 0, roi noir 13, Dame 12, Valet 11, pouvoirs sur 7/8, 9/10, Valet/Dame et
roi noir, défausse rapide autorisée, annonce libre, partie à 100 points. C'est la
version la plus riche, et celle que suivent
[nos règles détaillées](/blog/regles-du-jeu-de-cactus/).
...
Oui. « Tamalou » est un nom de colonie de vacances pour le même jeu ; les règles
sont identiques aux différences régionales près, notamment la valeur des figures.

### Le Cabo est-il différent du Cactus ?

Les mécaniques sont les mêmes. Le Cabo, plus courant en Belgique et en Israël, se
joue souvent avec un seuil pour annoncer et des pouvoirs plus limités.
...
La version complète, avec les pouvoirs et la défausse rapide. À deux, un jeu sans
pouvoirs se résume à retourner des cartes ; ce sont les 9, les 10 et l'échange
aveugle qui rendent la partie intéressante.
